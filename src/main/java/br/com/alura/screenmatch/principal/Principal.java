...
//        List<String > nomes = Arrays.asList("Gui", "Karen", "Henrique", "Caio");
//        nomes.stream().sorted().limit(3).filter(n -> n.startsWith("C")).map(n -> n.toUpperCase()).forEach(System.out::println);
...
//        System.out.println("Digite parte do título para a busca:");
